...
inline void populateGeneratedViewTemplates_Xcode4( ofPtr< ofxGenericView > rootView, ofPtr< ofxGenericTextView > &variableNameLabel, ofPtr< ofxGenericButtonView > &variableNameButton1, ofPtr< ofxGenericButtonView > &variableNameButton2, ofPtr< ofxGenericImageView > &variableNameImage, ofPtr< ofxGenericView > &variableNameView, ofPtr< ofxGenericTextView > &variableNameLabel2 )
{
	...
	variableNameButton1->setDownTextColor( ofColor( (int)( 1.0f * 255 ), (int)( 1.0f * 255 ), (int)( 1.0f * 255 ), (int)( 1.0f * 255 ) ) );
	...
	variableNameButton1->setTextColor( ofColor( (int)( 0.219608f * 255 ), (int)( 0.329412f * 255 ), (int)( 0.529412f * 255 ), (int)( 1.0f * 255 ) ) );
	...
	variableNameButton2->setDownTextColor( ofColor( (int)( 1.0f * 255 ), (int)( 1.0f * 255 ), (int)( 1.0f * 255 ), (int)( 1.0f * 255 ) ) );
	...
	variableNameButton2->setTextColor( ofColor( (int)( 0.219608f * 255 ), (int)( 0.329412f * 255 ), (int)( 0.529412f * 255 ), (int)( 1.0f * 255 ) ) );
